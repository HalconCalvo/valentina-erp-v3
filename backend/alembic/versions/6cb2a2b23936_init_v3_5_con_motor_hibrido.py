"""Init V3.5 con Motor Hibrido

Revision ID: 6cb2a2b23936
Revises: 
Create Date: 2026-03-19 11:49:46.218610
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('production_batches', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_production_batches_folio'), ['folio'], unique=False)
    ...
    sa.Column('production_status', sa.Enum('PENDING', 'IN_PRODUCTION', 'READY', 'CARGADO', 'INSTALLED', 'CLOSED', name='instancestatus'), nullable=False),
