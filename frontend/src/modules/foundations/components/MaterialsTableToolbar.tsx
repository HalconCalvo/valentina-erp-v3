    ...
    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 py-4 bg-white p-4 rounded-lg border border-slate-200 shadow-sm mb-4">
      <div className="flex flex-1 flex-wrap items-center gap-3 w-full">
        ...
        <div className="relative w-full md:w-auto">
            ...
            className="h-9 w-full md:w-[150px] pl-9 pr-4 rounded-md border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            />
        </div>
