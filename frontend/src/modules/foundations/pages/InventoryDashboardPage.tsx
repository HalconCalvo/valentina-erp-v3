        ...
        <div className="p-8 max-w-7xl mx-auto space-y-6 animate-fadeIn pb-24">
            ...
            {!activeSection ? (
                <div className="flex flex-wrap justify-center gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 mt-4">
                    ...
                    {/* TARJETA 4 */}
                    <div className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] relative h-40">
                        <Card onClick={() => openMainSection('INVENTORY_HUB')} className="p-5 cursor-pointer hover:shadow-xl transition-all border-l-4 border-l-orange-500 transform hover:-translate-y-1 h-full bg-white overflow-hidden group">
